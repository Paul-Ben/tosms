                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('application.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="applicationId" class="col-md-4 col-form-label text-md-right">Application
                                    ID</label>

                                <div class="col-md-6">
                                    <input id="applicationId" type="text"
                                        class="form-control @error('applicationId') is-invalid @enderror"
                                        name="applicationId" value="{{ 'App/sch/dept/' . rand(0000, 9999) }}" required
                                        autocomplete="applicationId" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text"
                                        ...
                                        value="{{ old('phone') }}" required autocomplete="address">
